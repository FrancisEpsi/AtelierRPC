...
Module Base
    ...
    ''' <summary>
    ''' Classe utilisé par le client pour la communication avec le serveur
    ''' </summary>
    ...
    ''' <summary>
    ''' Classe utilisé par l'application serveur (NE SERT A RIEN DANS CE PROJET)
    ''' </summary>
    Public Class ServerRPC

        Public SenderForm As Object = Nothing
